                     ...
                     Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text("Soton Ahmed",style: TextStyle(fontWeight: FontWeight.bold),),
                            const Text("tasmia437@gmail.com"),
                            Text("Main: 500 | Mining: 01 | Team: 08",style: TextStyle(fontSize: 12,color: Theme.of(context).colorScheme.onSurfaceVariant),),
                          ],
                        ),
                      ),
                    ),
